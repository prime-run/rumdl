...
impl MD038NoSpaceInCode {
    ...
    fn looks_like_command(&self, content: &str) -> bool {
        ...
        let command_indicators = [
            "git ", "npm ", "cargo ", "docker ", "kubectl ", "pip ", "yarn ", "sudo ", "chmod ",
            "chown ", "ls ", "cd ", "mkdir ", "rm ", "cp ", "mv ", "cat ", "grep ", "find ",
            "awk ", "sed ",
        ];
...
impl Rule for MD038NoSpaceInCode {
        ...
        Self: Sized,
    {
        ...
        let allow_command_spaces =
            crate::config::get_rule_config_value::<bool>(config, "MD038", "allow_command_spaces")
                .unwrap_or(true);
